...
Current version: **v0.10.3** · Node backend + Vue 3 frontend · scrcpy 4.0 WebSocket build
...
- **Device entry**: top-right Add Device modal (Android / Huawei / Apple placeholders via Iconify brand icons)
