...
当前版本：**v0.9.7** · Node 后端 + Vue 3 前端 · 基于 [scrcpy](https://github.com/Genymobile/scrcpy) 4.0 自编译 WebSocket 投屏
...
- 可配置设备列表、截图刷新间隔（默认 1s / 5s）
- 会话登录（默认密码 `admin`，首次使用请改密）；支持修改密码、查看会话过期时间
- 浅色/深色主题，偏好持久化
