...
当前版本：**v0.10.5** · Node 后端 + Vue 3 前端 · 基于 [scrcpy](https://github.com/Genymobile/scrcpy) 4.0 自编译 WebSocket 投屏
...
| **设备入口** | 画廊右上角提供「添加设备」弹窗；安卓 USB 提供连接引导（动画 + 新设备实时状态），鸿蒙/苹果暂未开发 |
