...
- 左侧 Tab：设备画廊、设置；设备工作区含顶栏控制、左侧投屏模式与开始/取消按钮、右侧占位
...
- Left sidebar tabs: Devices gallery and Settings; device workspace with toolbar, left cast settings panel, right pane
...
- Sync frontend and backend versions to `0.4.2`
