...
const paths = {
  console:
    "M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6Zm4 10v4h8v-4",
  devices:
...
<template>
  <svg class="app-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
    <path :d="paths[name]" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>
